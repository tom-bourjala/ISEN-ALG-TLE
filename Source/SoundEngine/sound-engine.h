...
// a modifier si ca deviens la merde
...
typedef struct SoundEngine
{
    ...
    */
    ...
    /* @Pause all effects, musics and ambience tracks.
     */
    void (*pause)(void);

    /* @Resume all effects, musics and ambience tracks. All effects, musics and ambience tracks currently playing will be stopped.
     */
    void (*resume)(void);
} SoundEngine;
